...
import 'package:mantarix/src/models/page_args_model.dart';
import 'package:mantarix/src/utils/locale.dart';
...
import '../actions.dart';
import '../mantarix_app_context.dart';
...
class _PageControlState extends State<PageControl> with MantarixStoreMixin {
  bool? _adaptive;
  ...
  void _routeChanged() {
    widget.dispatch(SetPageRouteAction(
        _routeState.route, MantarixAppServices.of(context).server));
  }
  ...
  Widget build(BuildContext context) {
    ...
    // clear hrefs index
    MantarixAppServices.of(context).globalKeys.clear();
    ...
    _themeMode = ThemeMode.values.firstWhereOrNull((t) =>
        ...
        MantarixAppContext.of(context)?.themeMode;
  ...
  Widget _buildNavigator(
    ...
    return StoreConnector<AppState, RoutesViewModel>(
        ...
        builder: (context, routesView) {
          ...
          var hideLoadingPage =
              MantarixAppServices.of(context).hideLoadingPage ?? false;
...
class _ViewControlState extends State<ViewControl> with MantarixStoreMixin {
