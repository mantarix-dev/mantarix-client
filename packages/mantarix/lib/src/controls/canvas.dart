...
class MantarixCustomPainter extends CustomPainter {
  final BuildContext context;
  final ThemeData theme;
  final List<ControlTreeViewModel> shapes;
  final CanvasControlOnPaintCallback onPaintCallback;

  const MantarixCustomPainter(
  ...
  @override
  bool shouldRepaint(MantarixCustomPainter oldDelegate) {
    return true;
  }
