...
class MantarixWebSocketServerProtocol implements MantarixServerProtocol {
  late final String _wsUrl;
  late final bool _isLocalConnection;
  MantarixServerProtocolOnMessageCallback onMessage;
  MantarixServerProtocolOnDisconnectCallback onDisconnect;
  WebSocketChannel? _channel;

  MantarixWebSocketServerProtocol(
